...
The Zmanim Lab codebase demonstrates violations of concept independence principles from the "What You See Is What It Does" paper. However, **these violations are ACCEPTED as pragmatic technical debt** for the existing codebase.
