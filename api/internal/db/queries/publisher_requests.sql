...
INSERT INTO publishers (name, slug, email, description, status_id)
VALUES (
    $1,
    $2,
    $3,
    $4,
    (SELECT id FROM publisher_statuses WHERE key = 'pending_verification')
)
RETURNING id, name, slug, email, description, status_id, created_at;
