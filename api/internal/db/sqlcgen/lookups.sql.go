...
const getJewishEventTypeByKey = `-- name: GetJewishEventTypeByKey :one
SELECT id, key, display_name_hebrew, display_name_english, description
FROM jewish_event_types
WHERE key = $1
`

type GetJewishEventTypeByKeyRow struct {
	ID                 int16   `json:"id"`
	Key                string  `json:"key"`
	DisplayNameHebrew  string  `json:"display_name_hebrew"`
	DisplayNameEnglish string  `json:"display_name_english"`
...
func (q *Queries) GetJewishEventTypeByKey(ctx context.Context, key string) (GetJewishEventTypeByKeyRow, error) {
	row := q.db.QueryRow(ctx, getJewishEventTypeByKey, key)
	var i GetJewishEventTypeByKeyRow
	err := row.Scan(
		&i.ID,
		&i.Key,
		&i.DisplayNameHebrew,
...
const getJewishEventTypes = `-- name: GetJewishEventTypes :many
...
type GetJewishEventTypesRow struct {
	ID                 int16   `json:"id"`
	Key                string  `json:"key"`
	DisplayNameHebrew  string  `json:"display_name_hebrew"`
	DisplayNameEnglish string  `json:"display_name_english"`
...
// Jewish Event Types --
func (q *Queries) GetJewishEventTypes(ctx context.Context) ([]GetJewishEventTypesRow, error) {
	rows, err := q.db.Query(ctx, getJewishEventTypes)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	items := []GetJewishEventTypesRow{}
	for rows.Next() {
		var i GetJewishEventTypesRow
		if err := rows.Scan(
			&i.ID,
			&i.Key,
			&i.DisplayNameHebrew,
...
const getZmanSourceTypeByKey = `-- name: GetZmanSourceTypeByKey :one
SELECT id, key, display_name_hebrew, display_name_english, description
FROM zman_source_types
WHERE key = $1
`

type GetZmanSourceTypeByKeyRow struct {
	ID                 int16   `json:"id"`
	Key                string  `json:"key"`
	DisplayNameHebrew  string  `json:"display_name_hebrew"`
	DisplayNameEnglish string  `json:"display_name_english"`
...
func (q *Queries) GetZmanSourceTypeByKey(ctx context.Context, key string) (GetZmanSourceTypeByKeyRow, error) {
	row := q.db.QueryRow(ctx, getZmanSourceTypeByKey, key)
	var i GetZmanSourceTypeByKeyRow
	err := row.Scan(
		&i.ID,
		&i.Key,
		&i.DisplayNameHebrew,
...
const getZmanSourceTypes = `-- name: GetZmanSourceTypes :many
...
type GetZmanSourceTypesRow struct {
	ID                 int16   `json:"id"`
	Key                string  `json:"key"`
	DisplayNameHebrew  string  `json:"display_name_hebrew"`
	DisplayNameEnglish string  `json:"display_name_english"`
...
// Zman Source Types --
func (q *Queries) GetZmanSourceTypes(ctx context.Context) ([]GetZmanSourceTypesRow, error) {
	rows, err := q.db.Query(ctx, getZmanSourceTypes)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	items := []GetZmanSourceTypesRow{}
	for rows.Next() {
		var i GetZmanSourceTypesRow
		if err := rows.Scan(
			&i.ID,
			&i.Key,
			&i.DisplayNameHebrew,
