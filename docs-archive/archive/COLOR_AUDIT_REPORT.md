# Color Accessibility Audit Report - Shtetl Zmanim
...
A comprehensive accessibility audit was conducted on the Shtetl Zmanim application to identify color combinations that don't meet WCAG AA standards (4.5:1 contrast ratio for normal text, 3:1 for large text and UI components).
