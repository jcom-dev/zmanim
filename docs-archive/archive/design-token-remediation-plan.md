...
This plan addresses inconsistent color usage across the Shtetl Zmanim frontend codebase. The audit identified approximately **60+ files** with design token violations that need remediation to ensure:
