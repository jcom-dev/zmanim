...
# Note: Database uses local postgres in Coder environment
...
zmanim_branch = "main"
zmanim_repo   = "git@github.com:jcom-dev/zmanim.git"
...
cd "$SCRIPT_DIR"
coder templates push zmanim --directory . --yes

echo ""
echo "✅ Template pushed successfully!"
echo ""
echo "To create a workspace:"
echo "  coder create zmanim-dev --template zmanim"
