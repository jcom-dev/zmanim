...
# Zmanim Lab Development Environment Startup Script (Fast Version)
# This script handles runtime configuration only
# All dependencies are pre-installed in the Docker image

echo "🚀 Starting Zmanim Lab Development Environment..."
...
echo "=========================================="
echo ""
echo "📦 Pre-installed (in Docker image):"
...
echo ""
echo "🛠️  Services (local Coder containers):"
