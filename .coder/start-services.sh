#!/bin/bash
# Helper script to start all Shtetl Zmanim services in tmux
...
echo "🚀 Starting Shtetl Zmanim services in tmux..."
...
tmux new-window -t zmanim -n web "cd $PROJECT_ROOT/web && npm run dev -- -H ${WEB_HOST:-0.0.0.0} -p ${WEB_PORT:-3001}"
