 ...
 *
 * Features:
 * - 3-state selector for negatable tags (event, timing, jewish_day)
 * - Simple checkboxes for non-negatable tags (shita, calculation, category)
      ...
      {negatableTags.length > 0 && (
        <div className="space-y-2">
          <label className="text-sm font-medium text-foreground">
            Event & Jewish Day Tags (Include/Exclude)
          </label>
