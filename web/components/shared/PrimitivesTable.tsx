...
import { Sun, Sunrise, Moon, Clock, Loader2, Info, BookOpen, Calculator, Compass, FlaskConical, Copy, Check, ExternalLink, Code, ChevronDown, ChevronUp, FileText, Scale } from 'lucide-react';
