 ...
 * Only event and jewish_day tags can be negated
 * Other types (timing, shita, calculation, category) use simple checkboxes
 */
export const NEGATABLE_TAG_TYPES = ['event', 'jewish_day'] as const;
 ...
 * @returns true if tag type is event, timing, or jewish_day
 */
