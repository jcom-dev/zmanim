    ...
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold">Correction Requests</h1>
          <p className="text-sm sm:text-base text-muted-foreground mt-1">
            Track your submitted correction requests for global city data
          </p>
        </div>
        ...
        {requests.length === 0 ? (
          <div className="bg-card rounded-lg border border-border p-8 sm:p-12 text-center">
            ...
            <p className="text-sm sm:text-base text-muted-foreground mb-4">
              You have not submitted any correction requests yet. You can submit correction requests
              from the coverage page when viewing city details.
            </p>
          </div>
        ) : (
                  ...
                  {requests.map((request) => (
                    <tr key={request.id} className="hover:bg-muted/30">
                      <td className="px-4 py-3">
                        <div className="font-medium">{request.city_name}</div>
          ...
          <Dialog open={detailsDialogOpen} onOpenChange={setDetailsDialogOpen}>
            <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
              <DialogHeader>
                ...
                <DialogDescription>
                  Request for {selectedRequest.city_name}, {selectedRequest.country_name}
                </DialogDescription>
              </DialogHeader>
