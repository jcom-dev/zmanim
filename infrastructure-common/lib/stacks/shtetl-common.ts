...
export class ShtetlCommonStack extends TerraformStack {
  ...
  constructor(scope: Construct, id: string, options: ShtetlCommonStackOptions) {
    ...
    new Route53Record(this, "cname-acm-validation", {
      zoneId: this.hostedZone.zoneId,
      name: "_8733c97b4f6273f99257413ae41aafe9.zmanim.shtetl.io",
      type: "CNAME",
      ttl: 300,
      records: ["_18b3a92ad19f4c2fba66d9f54e568746.jkddzztszm.acm-validations.aws."],
    });
